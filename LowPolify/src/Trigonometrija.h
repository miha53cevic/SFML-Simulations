...
struct Vector2
{
    ...
    bool operator== (Vector2<T> rb)
    {
        if (this->x == rb.x && this->y == rb.y) return true; 
        else return false; 
    }
...
struct Edge
{
    ...
    bool operator== (Edge rb)
    {
        if (this->a == rb.a && this->b == rb.b) return true;
        if (this->a == rb.b && this->b == rb.a) return true;
        else return false;
    }
...
struct Triangle
{
    ...
    bool operator== (Triangle rb)
    {
        if (this->edges[0] == rb.edges[0] && this->edges[1] == rb.edges[1] && this->edges[2] == rb.edges[2]) return true;
        else return false;
    }
